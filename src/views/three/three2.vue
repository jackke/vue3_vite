...
export default {
    ...
    setup() {  
        ...
        function threeFn(){
            ...
            console.log(webgl.clientWidth, innerWidth, window);
            ...
            renderer.setSize(webgl.clientWidth, webgl.clientHeight);
            // document.body.appendChild(renderer.domElement);
            document.getElementById('webgl').appendChild(renderer.domElement)

            window.addEventListener("resize", event => {
                camera.aspect = webgl.clientWidth / webgl.clientHeight;
